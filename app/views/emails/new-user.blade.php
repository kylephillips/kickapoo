	...
	<table width="100%" cellpadding="0" cellspacing="0" style="padding-top:30px;">
		<tr><td>
			...
			<table id="main" width="600" align="center" cellpadding="0" cellspacing="0" bgcolor="ffffff" style="border:1px solid #ccc;margin-bottom:10px;">
				...
				<tr>
					<td>
						<h2 style="font-family: Arial, Helvetica, sans-serif; line-height: 1.4; margin: 0px 0 10px 0; background-color:#ebebec; padding: 10px; text-align:center; font-size:18px; color:#00581c;">Welcome to Kickapoo!</h2>
					</td>
				</tr>
				<tr>
